package com.anuj.project.simplerssreaderapp.activities;
...
import com.anuj.project.simplerssreaderapp.R;
import com.anuj.project.simplerssreaderapp.model.*;
import com.anuj.project.simplerssreaderapp.parser.RSSParser;
import com.anuj.project.simplerssreaderapp.handler.RSSDatabaseHandler;
...
public class AndroidRSSReaderApplicationActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_android_rssreader_application, menu);
        return true;
    }
    ...
    class LoadStoreSites extends AsyncTask<String, String, String> {
        ...
        public void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AndroidRSSReaderApplicationActivity.this);
